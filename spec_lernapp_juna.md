...
A Progressive Web App (PWA) for practising English (Green Line, Klett-Verlag), usable offline on iPad/iPhone/Mac. Covers **grammar**, **vocabulary**, and **conversation** practice, plus a dedicated **exam prep mode**. Built to scale beyond Grade 5 into Grade 6 as more units are added later.
